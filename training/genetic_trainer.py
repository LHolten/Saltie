...
if __name__ == '__main__':
    ...
    # parent = SymmetricModel()
    # parent.load_state_dict(torch.load('exercise_0.mdl'))
    # ga.crossover(parent, models)
    ...
    with setup_manager_context() as setup_manager:
        while True:
            ...
            while bot < bot_count:
                ...
                logger.info(f'BOT: {bot} {fitness[bot]}')  # +str(models[bot].state_dict())) # Log Info
